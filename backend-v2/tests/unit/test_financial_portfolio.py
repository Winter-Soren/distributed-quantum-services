...
def _wide_prices_csv() -> bytes:
    return (
        "date,AAPL,MSFT,NVDA,IBM\n"
        "2025-01-01,100,200,150,90\n"
        "2025-01-02,102,201,153,91\n"
        "2025-01-03,101,205,157,92\n"
        "2025-01-04,104,208,160,91\n"
        "2025-01-05,106,210,166,93\n"
        "2025-01-06,108,214,170,94\n"
    ).encode("utf-8")
...
def _long_returns_csv() -> bytes:
    return (
        "date,ticker,return\n"
        "2025-01-01,AAPL,0.010\n"
        "2025-01-01,MSFT,0.004\n"
        "2025-01-01,NVDA,0.015\n"
        "2025-01-01,IBM,0.002\n"
        "2025-01-02,AAPL,-0.002\n"
        "2025-01-02,MSFT,0.003\n"
        "2025-01-02,NVDA,0.011\n"
        "2025-01-02,IBM,0.001\n"
        "2025-01-03,AAPL,0.006\n"
        "2025-01-03,MSFT,0.005\n"
        "2025-01-03,NVDA,-0.004\n"
        "2025-01-03,IBM,0.002\n"
        "2025-01-04,AAPL,0.003\n"
        "2025-01-04,MSFT,-0.001\n"
        "2025-01-04,NVDA,0.009\n"
        "2025-01-04,IBM,0.001\n"
        "2025-01-05,AAPL,0.004\n"
        "2025-01-05,MSFT,0.006\n"
        "2025-01-05,NVDA,0.013\n"
        "2025-01-05,IBM,0.002\n"
    ).encode("utf-8")
...
def test_build_portfolio_artifacts_from_wide_prices() -> None:
    ...
    assert payload["solver_diagnostics"]["quantum_solver"]["strategy"] == "grid_plus_local_refinement"
...
def test_build_portfolio_artifacts_from_long_returns() -> None:
    ...
    assert payload["benchmark"]["comparison"]["feasible_probability_mass"] >= 0.0
