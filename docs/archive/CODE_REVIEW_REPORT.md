...
- legacy `backend`
- legacy `frontend`
- root-level deployment files such as `docker-compose.yaml`, unless a `backend-v2` or `frontend-v2` issue depended on them

One exception was allowed: `backend-v2/src/quantum_backend_v2/application/parity.py` directly imports code from `backend/src`, so that dependency is reviewed as a `backend-v2` packaging/runtime concern.
...
- `backend-v2`: `..\backend-v2\.venv\Scripts\python.exe -m pytest tests\unit -q`
  Result: `102 passed, 2 failed`.
  Failing tests:
  - `backend-v2/tests/unit/test_config_loader.py::test_load_settings_reads_environment_overrides`
  - `backend-v2/tests/unit/test_persistence.py::test_local_peer_log_store_appends_and_replays`
...
- `frontend-v2/src/lib/backend-client.ts`
  The frontend backend client authenticates with `X-API-Key`, but `backend-v2` auth only parses `Authorization: Bearer ...`. As soon as `QB2_AUTH_REQUIRED=true`, the new frontend integration breaks for runs, finance, and circuit submission with 401s.

- `backend-v2/src/quantum_backend_v2/api/deps/auth.py`
...
- `backend-v2/src/quantum_backend_v2/api/routers/financial.py`
...
- `backend-v2/src/quantum_backend_v2/api/routers/circuits.py`
  `backend-v2/src/quantum_backend_v2/application/parity.py`
...
- `backend-v2/src/quantum_backend_v2/api/routers/plans.py`
  `backend-v2/src/quantum_backend_v2/application/parity.py`
...
- `backend-v2/src/quantum_backend_v2/api/routers/enrollment.py`
...
- `backend-v2/src/quantum_backend_v2/application/enrollment.py`
...
- `backend-v2/src/quantum_backend_v2/api/routers/discovery.py`
...
- `backend-v2/src/quantum_backend_v2/discovery/models.py`
  `backend-v2/src/quantum_backend_v2/discovery/registry.py`
  `backend-v2/src/quantum_backend_v2/api/routers/services.py`
...
- `backend-v2/src/quantum_backend_v2/libp2p/transport.py`
...
- `backend-v2/src/quantum_backend_v2/api/app.py`
...
- `backend-v2/src/quantum_backend_v2/bootstrap/application.py`
...
- `backend-v2/src/quantum_backend_v2/api/routers/workflows.py`
...
- `backend-v2/src/quantum_backend_v2/api/routers/workflows.py`
  `backend-v2/src/quantum_backend_v2/workflows/benchmark.py`
...
- `backend-v2/src/quantum_backend_v2/api/routers/reservations.py`
...
- `backend-v2/src/quantum_backend_v2/reservations/service.py`
...
- `backend-v2/src/quantum_backend_v2/main.py`
...
- `backend-v2/src/quantum_backend_v2/api/routers/system.py`
...
- `backend-v2/src/quantum_backend_v2/discovery/service.py`
...
- `backend-v2/src/quantum_backend_v2/persistence/runtime.py`
  `backend-v2/src/quantum_backend_v2/bootstrap/application.py`
  `backend-v2/src/quantum_backend_v2/discovery/service.py`
...
- `backend-v2/src/quantum_backend_v2/runtime/service.py`
...
- `backend-v2/src/quantum_backend_v2/application/parity.py`
  `backend-v2/Dockerfile`
  `backend-v2` circuit execution still depends on importing `backend/src` at runtime via `sys.path` injection. That makes `backend-v2` non-independent for packaging, deployment, and versioning.
...
- `frontend-v2/src/lib/backend-normalizers.ts`
  Minimal backend-v2 categorical `count` values are reused as `non_null_count`. Any UI that starts using `non_null_count` for categorical columns will significantly underreport populated rows.
...
- `backend-v2/src/quantum_backend_v2/reservations/models.py`
