...
import { RiskQuantumSummary } from "@/features/risk/components/risk-quantum-summary";

export default function RiskQuantumPage() {
  ...
  return (
    <div className="flex min-h-full flex-col">
      <PageHeader
        ...
        description="IQAE circuit, qubit states, and CVaR convergence diagnostics."
        glow="rose"
      />
      <div className="relative flex-1 overflow-y-auto p-6">
        <div className="pointer-events-none absolute inset-x-0 top-0 overflow-hidden" style={{ height: "280px" }}>
          <div
            ...
            style={{ left: "5%", top: "-40px", background: "radial-gradient(circle, rgba(251,113,133,0.35) 0%, transparent 70%)" }}
          />
          <div
            className="absolute h-[200px] w-[250px] rounded-full opacity-8 blur-[75px]"
            style={{ right: "10%", top: "-20px", background: "radial-gradient(circle, rgba(244,63,94,0.3) 0%, transparent 70%)" }}
          />
        </div>
