    ...
    <div className="relative flex flex-col gap-6 p-6">
      ...
      <div className="pointer-events-none absolute inset-x-6 top-0 overflow-hidden" style={{ height: "420px" }}>
        <div
          ...
          style={{ left: "0%", top: "-60px", background: "radial-gradient(circle, rgba(34,211,238,0.7) 0%, transparent 70%)" }}
        />
        <div
          className="absolute h-[280px] w-[260px] rounded-full opacity-20 blur-[80px]"
          style={{ left: "35%", transform: "translateX(-50%)", top: "-40px", background: "radial-gradient(circle, rgba(99,102,241,0.65) 0%, transparent 70%)" }}
        />
        <div
          className="absolute h-[280px] w-[260px] rounded-full opacity-20 blur-[80px]"
          style={{ left: "70%", transform: "translateX(-50%)", top: "-40px", background: "radial-gradient(circle, rgba(167,139,250,0.65) 0%, transparent 70%)" }}
        />
        <div
          className="absolute h-[320px] w-[280px] rounded-full opacity-25 blur-[90px]"
          style={{ right: "0%", top: "-60px", background: "radial-gradient(circle, rgba(52,211,153,0.7) 0%, transparent 70%)" }}
        />
      </div>
      ...
      <div className="relative z-10 flex flex-col gap-6">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-0.5 text-sm text-white/40">Live network peer topology and connectivity.</p>
          </div>
        </div>
